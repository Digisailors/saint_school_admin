...
class _AppoinmentListState extends State<AppoinmentList> {
  ...
  Widget build(BuildContext context) {
    var sourcelist = AppointmentSource(source, context,);
            ...
            child: Column(
              children: [
                SingleChildScrollView(
                  ...
                  child: SizedBox(
                    width: isMobile(context) ? getWidth(context)*3 : getWidth(
                        context) * 0.80,
                    child: Row(
                              ...
                              onChanged: (text) {
                                setState(() {
                                  if (controller.classField != text) {
                                    controller.classField =
                                        text ?? controller.classField;
                ...
                ConstrainedBox(
                  constraints: BoxConstraints(
                    minWidth: getWidth(context) * 0.90, maxWidth: 1980,),
